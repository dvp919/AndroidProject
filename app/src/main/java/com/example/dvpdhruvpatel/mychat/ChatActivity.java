...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View action_bar_view = layoutInflater.inflate(R.layout.chat_custom_baar,null);
        ...
        rootRef.child("Users").child(messageReceiverId).addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                ...
                Picasso.get().load(userThumb).networkPolicy(NetworkPolicy.OFFLINE).placeholder(R.drawable.welcome_page)
                        .into(userChatProfileImage, new Callback()
                        {
                            ...
                            {
                                Picasso.get().load(userThumb).placeholder(R.drawable.welcome_page).into(userChatProfileImage);
                            }
                        });
