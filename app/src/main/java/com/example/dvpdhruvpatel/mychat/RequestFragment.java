...
public class RequestFragment extends Fragment {
    ...
    private DatabaseReference FriendsRequestReferance;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        FriendsRequestReferance = FirebaseDatabase.getInstance().getReference().child("Friends_Requests").child(online_user_id);
        ...
        linearLayoutManger.setReverseLayout(true);
        linearLayoutManger.setStackFromEnd(true);

        myRequestsList.setLayoutManager(linearLayoutManger);
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<Requests, RequestViewHolder> firebaseRecyclerAdapter
                ...
                (
                        ...
                        FriendsRequestReferance
                )
        {
            @Override
            protected void populateViewHolder(RequestViewHolder viewHolder, Requests model, int position) {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if(dataSnapshot.exists())
                        {
                            ...
                            if(request_type.equals("received")) {
                                ...
                                UsersReferance.child(list_users_id).addValueEventListener(new ValueEventListener() {
                                    @Override
                                    public void onDataChange(DataSnapshot dataSnapshot) {
                                                ...
                                                builder.setItems(options, new DialogInterface.OnClickListener()
                                                {
                                                    ...
                                                    public void onClick(DialogInterface dialogInterface, int position)
                                                    {
                                                        if (position == 0)
                                                        {
                                                            ...
                                                            FriendsDatabaseRef.child(online_user_id).child(list_users_id).child("date").setValue(save_current_date)
                                                                    .addOnCompleteListener(new OnCompleteListener<Void>()
                                                                    {
                                                                        @Override
                                                                        public void onComplete(@NonNull Task<Void> task)
                                                                        {
                                                                            FriendsDatabaseRef.child(list_users_id).child(online_user_id).child("date").setValue(save_current_date).addOnSuccessListener(new OnSuccessListener<Void>()
                                                                            {
                                                                                @Override
                                                                                            ...
                                                                                            if (task.isSuccessful())
                                                                                            {
                                                                                                FriendsReqDatabaseRef.child(list_users_id).child(online_user_id).removeValue().addOnCompleteListener(new OnCompleteListener<Void>()
                                                                                                {
                                                                                                    ...
                                                                                                    public void onComplete(@NonNull Task<Void> task)
                                                                                                    {
                                                                                                        if (task.isSuccessful())
                                                                                                        {
                                                                                                            Toast.makeText(getContext(),"Friend Request Accepted!",Toast.LENGTH_SHORT);
                                                                                                        }
                                                                                                    }
                                                                                                });
                                                                                            }
                                                                    ...
                                                                    if (task.isSuccessful())
                                                                    {
                                                                        FriendsReqDatabaseRef.child(list_users_id).child(online_user_id).removeValue().addOnCompleteListener(new OnCompleteListener<Void>()
                                                                        {
                                                                            ...
                                                                            public void onComplete(@NonNull Task<Void> task)
                                                                            {
                                                                                if (task.isSuccessful())
                                                                                {
                                                                                    Toast.makeText(getContext(),"Friend Request Rejected!",Toast.LENGTH_SHORT);
                                                                                }
                                                                            }
                                                                        });
                                                                    }
    ...
    public static class RequestViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setThumb_user_image(String thumbImage, final Context ctx) {
            final CircleImageView thumb_image = (CircleImageView) mView.findViewById(R.id.request_profile_image);


            Picasso.get().load(thumbImage).networkPolicy(NetworkPolicy.OFFLINE).placeholder(R.drawable.welcome_page)
                    .into(thumb_image, new Callback()
                    {
                        ...
                        {
                            Picasso.get().load(thumbImage).placeholder(R.drawable.welcome_page).into(thumb_image);
                        }
                    });
        }
        ...
        {
            TextView status = (TextView) mView.findViewById(R.id.request_user_status);
